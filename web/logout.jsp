...
<html>
    ...
    <body>
        ...
        <div class="w3-bar w3-red w3-card w3-left-align w3-large">
            ...
            <a href="welcomePage.jsp" class="w3-bar-item w3-button w3-right w3-padding-large w3-white">Main</a>
        <a href="login.jsp" class="w3-bar-item w3-button w3-right w3-hide-small w3-padding-large w3-hover-white">Login</a>
        ...
        <header class="w3-container w3-red w3-center" style="padding:128px 16px">
            <h1 class="w3-margin w3-jumbo">Logged out</h1>
        </header>
        <%
